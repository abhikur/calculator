...
public class ExpressionValidator {
    ...
    private static final String TWO_INVALID_OPERATORS_TOGETHER_REGEX = "\\d+\\+\\*|\\+\\/|-\\*|-\\/|\\*\\/|\\/\\*|\\*{2}|\\/\\/\\d+";

    public static void validate(String expression) {
        Pattern pattern = Pattern.compile(INVALID_CHAR_REGEX);
        Pattern multipleOperatorsPattern = Pattern.compile(TWO_INVALID_OPERATORS_TOGETHER_REGEX);
